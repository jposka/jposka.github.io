...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-10762913.968993, 4914418.832172, -10026483.347914, 5397143.171343], maxZoom: 28, minZoom: 6
    })
});
...
map.getView().fit([-10762913.968993, 4914418.832172, -10026483.347914, 5397143.171343], map.getSize());
